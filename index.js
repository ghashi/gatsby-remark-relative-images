...
var select = require('unist-util-select').selectAll;
...
module.exports = function (_ref, pluginOptions) {
  ...
  var markdownImageNodes = select("image", markdownAST); // This will also allow the use of html image tags

  var rawHtmlNodes = select("html", markdownAST); // Promise markdown images in body
